...
export const civitaiModelVersionsRelations = relations(civitaiModelVersions, ({ one, many }) => ({
...
export type SelectCivitaiModelVersion = typeof civitaiModelVersions.$inferSelect;
export type InsertCivitaiModelVersion = typeof civitaiModelVersions.$inferInsert;
